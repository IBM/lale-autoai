...
project = 'lale-autoai'
copyright = '2020, IBM AI Research'
...
htmlhelp_basename = "lale_autoai_doc"
...
latex_documents = [
    (master_doc, "LALEAutoAI.tex", "LALEAutoAI Documentation", "IBM AI Research", "manual"),
]
...
man_pages = [(master_doc, "laleautoai", "LALEAutoAI Documentation", [author], 1)]
